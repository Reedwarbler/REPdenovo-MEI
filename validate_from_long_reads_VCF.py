        ...
        for line in fin_fai:
            ...
            with open(sf_gntp) as fin_gntp:
                for gntp_line in fin_gntp:
                    ...
                    if g1>3 and g1>g0:#here for temporary cutoff################################################################################
...
if __name__ == "__main__":
    ...
    sf_ref=sys.argv[2]
    allowed_dist=int(sys.argv[3]) #Max allowed distance between the two aligned flanks
    n_threads=int(sys.argv[4])
    sf_out_folder=sys.argv[5]
